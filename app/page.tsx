...
// Optimize components with dynamic imports for better performance
...
const RotatingWords = dynamic(() => import('./components/RotatingHeadline'), {
  ssr: false
});
...
export default function Home() {
  ...
  useEffect(() => {
    const preloadImages = [
      '/images/growthaccess-removebg-preview.png',
      '/images/logo.png',
      '/images/1752723677506.jpeg',
      '/images/coffee.jpg'
    ];
  ...
  // Optimized Image Component with better iOS support
  const OptimizedImage = useCallback(({ 
    ...
    <div className={`relative overflow-hidden rounded-xl bg-slate-100 dark:bg-slate-800 shadow-lg ${className}`}>
      <Image
        src={src}
        alt={alt}
        fill
        ...
        onError={(e) => {
          // Fallback for iOS image loading issues
  ...
  // Service data with optimized images
      ...
      <main className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-950 dark:via-blue-950 dark:to-indigo-950">
        ...
        <section id="services-web" className="py-24 md:py-36 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-blue-50/20 to-white dark:from-slate-900 dark:to-slate-950">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="marquee mt-10 overflow-hidden relative">
              <div className="marquee-track gap-8 flex">
                {[...serviceData.web, ...serviceData.web].map((src, i) => (
                  <div key={i} className="flex-shrink-0 w-[250px] md:w-[500px] h-40 md:h-80">
                    <OptimizedImage
                      src={src}
                      alt={`Website Development ${i + 1}`}
                      className="h-full"
                      priority={i < 2}
                    />
                  </div>
        ...
        <section id="services-marketing" className="py-24 md:py-36 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-blue-50/20 dark:from-slate-950 dark:to-slate-900">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="marquee mt-10 overflow-hidden relative">
              <div className="marquee-track gap-8 flex">
                {[...serviceData.marketing, ...serviceData.marketing].map((src, i) => (
                  <div key={i} className="flex-shrink-0 w-[250px] md:w-[500px] h-40 md:h-80">
                    <OptimizedImage
                      src={src}
                      alt={`Marketing Showcase ${i + 1}`}
        ...
        <section id="services-automation" className="py-24 md:py-36 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-blue-50/20 to-white dark:from-slate-900 dark:to-slate-950">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="marquee mt-10 overflow-hidden relative">
              <div className="marquee-track gap-8 flex">
                {[...serviceData.automation, ...serviceData.automation].map((src, i) => (
                  <div key={i} className="flex-shrink-0 w-[250px] md:w-[500px] h-40 md:h-80">
                    <OptimizedImage
                      src={src}
                      alt={`Automation Showcase ${i + 1}`}
                      className="h-full"
                      priority={i < 2}
                    />
                  </div>
        ...
        <section id="services-mobile" className="py-24 md:py-36 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-blue-50/20 to-white dark:from-slate-900 dark:to-slate-950">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="marquee mt-10 overflow-hidden relative">
              <div className="marquee-track gap-8 flex">
                {[...serviceData.mobile, ...serviceData.mobile].map((src, i) => (
                  <div key={i} className="flex-shrink-0 w-[250px] md:w-[500px] h-40 md:h-80">
                    <OptimizedImage
                      src={src}
                      alt={`Mobile App ${i + 1}`}
        ...
        {/* Enhanced Real Estate Consultation Section */}
            ...
            <div className="bg-white dark:bg-slate-900 rounded-3xl overflow-hidden border border-slate-200 dark:border-slate-800 shadow-2xl">
              <div className="grid md:grid-cols-2">
                <div className="relative h-96 md:h-auto min-h-[500px]">
                  ...
                  />
                  <div className="absolute bottom-6 left-6 bg-white/90 dark:bg-slate-900/90 backdrop-blur px-5 py-3 rounded-xl text-base text-slate-700 dark:text-slate-300 border border-slate-200/70 dark:border-slate-700 shadow-lg">
                    Discuss Your Next Big Listing 🔑
                  </div>
                </div>

                <div className="p-10 md:p-12 lg:p-14">
                  <p className="text-sm uppercase tracking-widest text-blue-600 dark:text-blue-400 font-semibold mb-3">
                    Real Estate Growth Strategy
                  </p>
                  ...
                  <div className="flex items-center gap-6 mb-8">
                    <div className="relative w-20 h-20 rounded-full overflow-hidden ring-3 ring-blue-200 dark:ring-blue-900 shadow-lg">
                      <Image 
                        src="/images/1752723677506.jpeg" 
                        alt="Digital Strategist" 
                        fill 
                    ...
                    <div>
                      <p className="text-xl font-bold text-slate-900 dark:text-white">Mudassar Nazir</p>
                      <p className="text-base text-slate-500">Real Estate & Digital Strategist</p>
                      <div className="flex items-center gap-2 mt-2">
                        ...
                        <span className="text-sm text-slate-500">50+ Projects</span>
                      </div>
                    </div>
                  </div>

                  <div className="bg-slate-50 dark:bg-slate-800 rounded-xl p-6 mb-10">
                    <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
                      <span className="font-bold text-blue-600 dark:text-blue-400">Specializes in:</span> AI automation, targeted digital campaigns, CRM integration, and conversion optimization for real estate agencies.
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-6">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 inline-flex items-center justify-center gap-3 px-8 py-4 rounded-xl bg-gradient-to-r from-emerald-600 to-green-600 hover:from-emerald-700 hover:to-green-700 text-white font-semibold transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/30 text-lg text-center"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 inline-flex items-center justify-center gap-3 px-8 py-4 rounded-xl bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 border-2 border-slate-300 dark:border-slate-600 hover:bg-slate-50 dark:hover:bg-slate-700 font-semibold transition-all duration-300 hover:shadow-lg text-lg text-center"
                    >
              ...
              <div className="relative px-4 sm:px-8 lg:px-12 py-12 md:py-16">
                ...
                <div className="mx-auto max-w-2xl">
                  <form onSubmit={handleSubmit} className="bg-white dark:bg-slate-800 rounded-2xl p-6 md:p-8 lg:p-10 shadow-xl border border-slate-200 dark:border-slate-700 pb-28 md:pb-0 relative z-10">
                    ...
                    {/* <div className="mb-6 md:mb-8">
                      <label htmlFor="budget" className="block text-xs md:text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
                        Budget Range
                      </label>
                      <input
                        type="text"
